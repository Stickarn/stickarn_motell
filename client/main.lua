...
function EnterMotell(name, owner)
  ...
  TriggerServerEvent('stickarn_motell:saveLastMotell', name)
...
function ExitMotell(name)
  ...
  TriggerServerEvent('stickarn_motell:deleteLastMotell')
  ...
  ESX.UI.Menu.Open(
    ...
    function(data2, menu)
      ...
      if data2.current.value == 'leave' then
        TriggerServerEvent('stickarn_motell:removeOwnedMotell', motell.name)
      end

      if data2.current.value == 'rent' then
        TriggerServerEvent('stickarn_motell:rentMotell', motell.name)
      end
    ...
    function(data, menu)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data2, menu)
          ...
          if data2.current.value == 'leave' then
            TriggerServerEvent('stickarn_motell:removeOwnedMotell', data.current.value)
          end
    ...
    function(data, menu)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data2, menu)
          ...
          if data2.current.value == 'rent' then
            TriggerServerEvent('stickarn_motell:rentMotell', data.current.value)
          end
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'player_dressing' then
        ...
        ESX.TriggerServerCallback('stickarn_motell:getPlayerDressing', function(dressing)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('stickarn_motell:getPlayerOutfit', function(clothes)
      ...
      if data.current.value == 'remove_cloth' then
        ...
        ESX.TriggerServerCallback('stickarn_motell:getPlayerDressing', function(dressing)
          ...
          ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'remove_cloth', {
            ...
            menu2.close()
            TriggerServerEvent('stickarn_motell:removeOutfit', data2.current.value)
...
function OpenRoomInventoryMenu(motell, owner)
  ...
  ESX.TriggerServerCallback('stickarn_motell:getMotellInventory', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('stickarn_motell:getItem', owner, data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                TriggerServerEvent('stickarn_motell:getItem', owner, data.current.type, data.current.value, quantity)
...
function OpenPlayerInventoryMenu(motell, owner)
  ...
  ESX.TriggerServerCallback('stickarn_motell:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('stickarn_motell:putItem', owner, data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('stickarn_motell:putItem', owner, data.current.type, data.current.value, tonumber(data2.value))
...
AddEventHandler('playerSpawned', function()
  ...
  if FirstSpawn then
    ...
    Citizen.CreateThread(function()
      ...
      ESX.TriggerServerCallback('stickarn_motell:getLastMotell', function(motellName)
...
AddEventHandler('stickarn_motell:getMotells', function(cb)
  cb(GetMotells())
end)

AddEventHandler('stickarn_motell:getMotell', function(name, cb)
  cb(GetMotell(name))
end)

AddEventHandler('stickarn_motell:getGateway', function(motell, cb)
  cb(GetGateway(motell))
end)

RegisterNetEvent('stickarn_motell:setMotellOwned')
AddEventHandler('stickarn_motell:setMotellOwned', function(name, owned)
...
AddEventHandler('esx:playerLoaded', function(xPlayer)
  ...
  ESX.TriggerServerCallback('stickarn_motell:getOwnedMotells', function(ownedMotells)
...
AddEventHandler('stickarn_motell:hasEnteredMarker', function(name, part)
...
AddEventHandler('stickarn_motell:hasExitedMarker', function(name, part)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)
...
Citizen.CreateThread(function()
  ...
  ESX.TriggerServerCallback('stickarn_motell:getMotells', function(motells)
...
Citizen.CreateThread(function()
  while true do
    ...
    if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastMotell ~= currentMotell or LastPart ~= currentPart) ) then
      ...
      TriggerEvent('stickarn_motell:hasEnteredMarker', currentMotell, currentPart)
    end
    ...
    if not isInMarker and HasAlreadyEnteredMarker then
      ...
      TriggerEvent('stickarn_motell:hasExitedMarker', LastMotell, LastPart)
    end
